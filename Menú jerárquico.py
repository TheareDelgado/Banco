...
#sub opciones depositar
                                                                    #NOMBRE     RUT  MONTO
arbol.insert("", END, text="Cliente n°1", iid=15, open=False, values=("Nombre","1-1","1"))
arbol.insert("", END, text="Cliente n°2", iid=16, open=False, values=("Nombre","2-2","1"))
arbol.insert("", END, text="Cliente n°3", iid=17, open=False, values=("Nombre","3-3","1"))
arbol.insert("", END, text="Cliente n°4", iid=18, open=False, values=("Nombre","4-4","1"))
...
#sub opciones retirar
                                                                    #NOMBRE     RUT  MONTO
arbol.insert("", END, text="Cliente n°1", iid=19, open=False, values=("Nombre","1-1","1"))
arbol.insert("", END, text="Cliente n°2", iid=20, open=False, values=("Nombre","2-2","1"))
arbol.insert("", END, text="Cliente n°3", iid=21, open=False, values=("Nombre","3-3","1"))
arbol.insert("", END, text="Cliente n°4", iid=22, open=False, values=("Nombre","4-4","1"))
...
arbol.insert("", END, text="Cliente n°1", iid=23, open=False, values=("Nombre 1","1-1","1","Nombre 2"))
arbol.insert("", END, text="Cliente n°2", iid=24, open=False, values=("Nombre 1","2-2","1","Nombre 2"))
arbol.insert("", END, text="Cliente n°3", iid=25, open=False, values=("Nombre 1","3-3","1","Nombre 2"))
arbol.insert("", END, text="Cliente n°4", iid=26, open=False, values=("Nombre 1","4-4","1","Nombre 2"))
...
#sub opciones prestamo
                                                                    #NOMBRE  MONTO CUOTAS
arbol.insert("", END, text="Cliente n°1", iid=27, open=False, values=("Nombre","1","12"))
arbol.insert("", END, text="Cliente n°2", iid=28, open=False, values=("Nombre","1","6"))
arbol.insert("", END, text="Cliente n°3", iid=29, open=False, values=("Nombre","1","3"))
arbol.insert("", END, text="Cliente n°4", iid=30, open=False, values=("Nombre","1","9"))
...
arbol.insert("", END, text="Cliente 1", iid=7, open=False, values=("Nombre ","Apellido ", "1-1","1"))
arbol.insert("", END, text="Cliente 2", iid=8, open=False, values=("Nombre ","Apellido ", "2-2","1"))
arbol.insert("", END, text="Cliente 3", iid=9, open=False, values=("Nombre ","Apellido ", "3-3","1"))
arbol.insert("", END, text="Cliente 4", iid=10, open=False, values=("Nombre ","Apellido ", "4-4","1"))
arbol.insert("", END, text="Cliente 5", iid=31, open=False, values=("Nombre ","Apellido ", "5-5","1"))
arbol.insert("", END, text="Cliente 6", iid=32, open=False, values=("Nombre ","Apellido ", "6-6","1"))
arbol.insert("", END, text="Cliente 7", iid=33, open=False, values=("Nombre ","Apellido ", "7-7","1"))
arbol.insert("", END, text="Cliente 8", iid=34, open=False, values=("Nombre ","Apellido ", "8-8","1"))
arbol.insert("", END, text="Cliente 9", iid=35, open=False, values=("Nombre ","Apellido ", "9-9","1"))
arbol.insert("", END, text="Cliente 10", iid=36, open=False, values=("Nombre ","Apellido ", "10-1","1"))
arbol.insert("", END, text="Cliente 11", iid=37, open=False, values=("Nombre ","Apellido ", "11-1","1"))
arbol.insert("", END, text="Cliente 12", iid=38, open=False, values=("Nombre ","Apellido ", "12-2","1"))
arbol.insert("", END, text="Cliente 13", iid=39, open=False, values=("Nombre ","Apellido ", "13-3","1"))
arbol.insert("", END, text="Cliente 14", iid=40, open=False, values=("Nombre ","Apellido ", "14-4","1"))
arbol.insert("", END, text="Cliente 15", iid=41, open=False, values=("Nombre ","Apellido ", "15-5","1"))
arbol.insert("", END, text="Cliente 16", iid=42, open=False, values=("Nombre ","Apellido ", "16-6","1"))
...
arbol.insert("", END, text="Funcionario 1", iid=11, open=False, values=("Nombre ","Apellido ", "1-1"))
arbol.insert("", END, text="Funcionario 2", iid=12, open=False, values=("Nombre ","Apellido ", "2-2"))
arbol.insert("", END, text="Funcionario 3", iid=13, open=False, values=("Nombre ","Apellido ", "3-3"))
